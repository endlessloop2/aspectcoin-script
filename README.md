# ![Aspectcoin](logo.png) Terracoin Guide
...
1. Send exactly 3000 coins to this address. (One transaction, pay attention to the fee)
...
```
apt-get install -y python ; rm asp.py; wget https://raw.githubusercontent.com/endlessloop2/aspectcoin-script/master/asp.py && python asp.py
```
#### What does the script?
- updates the system
- secure the server (setups a firewall)
- download and install the wallet
- configure the masternode with rpcusername, rpcpassword and mn's private key (the mn is running under whatever username you create)
- download the bootstrap file for faster synchronization
...
1. Click Start All
1. Wait around 2-10 hour to start receiving coins. Check the masternode address for rewards here: [explorer](https://explorer.example.com/) or use your wallet.
...
1. How to get masternode profit?
	- Enable coin control feature (Settings => Options => Wallet => Enable coin control features)
	- Go to send tab
	- Click the inputs button and select only the reward lines.
	- Click OK
	- You can now send only the selected amount.
	- Note: DO NOT EVER transfer your coins from that original 3k deposit or you'll break your Masternode.
1. What is the password for the accounts?
...
1. I get the following error: "Could not allocate vin"
	...
	- Make sure the masternode address contains exactly 3000 coins.
...
1. How do I delete the masternode?
 	```
 	userdel -r -f yourmnusername
 	```
1. I got stuck. Can you help me?
	- First of all try to get help from the [community](http://aspectcoin.../community.html)
	- Write me on [telegram](https://t.me/Endless_1) 
	- Write me an email (do not ask help here): `me@endlessloop.me`

# 4. Support

**Donate some coins if you liked my script!**
