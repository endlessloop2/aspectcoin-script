...
def setup_wallet():
    ...
    run_command("wget https://masternodes.host/dl/aspectcoind -O /usr/local/bin/{}".format(MN_DAEMON))
    run_command("chmod +x /usr/local/bin/{}".format(MN_DAEMON))
    run_command("wget https://masternodes.host/dl/aspectcoin-cli -O /usr/local/bin/{}".format(MN_CLI))
